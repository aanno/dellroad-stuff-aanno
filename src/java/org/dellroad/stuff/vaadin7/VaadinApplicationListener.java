 ...
 * with non-Vaadin event multicasters. This will ensure that events are delivered {@linkplain BaseContextApplication#invoke
...
public abstract class VaadinApplicationListener<E extends ApplicationEvent>
  extends VaadinExternalListener<ApplicationEventMulticaster> implements SmartApplicationListener {
     ...
     * <blockquote>
     *  {@link #VaadinApplicationListener(ApplicationEventMulticaster, Class, BaseContextApplication)
    ...
    public VaadinApplicationListener(ApplicationEventMulticaster multicaster, Class<E> eventType) {
        this(multicaster, eventType, BaseContextApplication.get());
    }
     ...
     */
    public VaadinApplicationListener(ApplicationEventMulticaster multicaster, Class<E> eventType, BaseContextApplication application) {
     ...
     * of the {@link BaseContextApplication} with which this listener is associated.
     * The current {@link BaseContextApplication} is also available via {@link BaseContextApplication#get}.
     *
