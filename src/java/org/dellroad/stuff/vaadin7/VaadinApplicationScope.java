 ...
 * {@link BaseContextApplication} instance. Spring {@linkplain org.springframework.beans.factory.DisposableBean#destroy destroy-methods}
 * will be invoked when the {@link BaseContextApplication} is closed.
 * </p>
 *
 * <p>
 ...
 * </p>
 */
public class VaadinApplicationScope implements Scope, BeanFactoryPostProcessor, BaseContextApplication.CloseListener {
    ...
    private final HashMap<BaseContextApplication, ApplicationBeanHolder> beanHolders
      = new HashMap<BaseContextApplication, ApplicationBeanHolder>();
...
// Scope methods
    ...
    public String getConversationId() {
        BaseContextApplication application = BaseContextApplication.currentApplication();
        if (application == null)
            return null;
    ...
    public Object resolveContextualObject(String key) {
        if (APPLICATION_KEY.equals(key))
            return BaseContextApplication.currentApplication();
        return null;
    }
...
// Internal methods
    ...
    private synchronized ApplicationBeanHolder getApplicationBeanHolder(boolean create) {
        BaseContextApplication application = BaseContextApplication.get();
...
// Bean holder class corresponding to a single Application instance
    ...
    private static class ApplicationBeanHolder {
        ...
        public ApplicationBeanHolder(BaseContextApplication application) {
